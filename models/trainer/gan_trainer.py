...
class GANTrainer():
    ...
    def saveCheckpoint(self, outDir, outLabel, scale, iter):
        ...
        outDir/outLabel_refVectors.pdparams -> reference vectors for visualization
        """
        pathModel = os.path.join(outDir, outLabel + ".pdparams")
        ...
        paddle.save(self.refVectorVisualization, self.pathRefVector)  ######
    ...
    def sendToVisualization(self, refVectorReal, scale, label=None):
        ...
        """
        imgSize = max(128, refVectorReal.shape[2])
    ...
    def getDBLoader(self, scale):
        ...
        return paddle.io.DataLoader(dataset,
